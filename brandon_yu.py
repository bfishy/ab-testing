...
# time_a_string = '25611	6978	17256	9373	5088	11057	441879	7302	5752	15681	5994	15376	25013	13839	11622	22537	13072	16111'
# time_b_string = '28990	15644	20273	277998	15803	6668	6532	32042	116975	77021	4962	9081	53087	6571	8307	10497	7821	12884	30052'
# time_a = data_to_num_list(time_a_string)
# time_b = data_to_num_list(time_b_string)

# rr = [[13, 5], [2, 17]]

# print('TIME AVG A:', get_avg(time_a))
# print('TIME AVG B:', get_avg(time_b))
# print('T_SCORE:', get_t_score(time_a, time_b))
# print('CHI^2 VAL:', chi2_value(rr))
# print('T P-VALUE:', perform_2_sample_t_test(time_a, time_b))
# print('CHI^2 P-VALUE:', perform_chi2_homogeneity_test(rr))
